...
<div>
    ...
    <fieldset>
        <dl>
                ...
                <div class="fieldbox video-urls">
                    ...
                    <?php if (isset($this->request->data['Service']['youtube_url'])):
                        foreach (unserialize($this->request->data['Service']['youtube_url']) as $youtube) :
                            ...
                            <a class="delete-video" data-target="<?php echo $count; ?>" href="#"
                               style="font-size:20px; font-weight:600; text-decoration:none;">-</a>
                            <?php
                            $count++;
                        endforeach;
                    endif;
                    ...
                    <a id="add-video" class="add-video" href="#"
                       style="font-size:20px; font-weight:600; text-decoration:none;">+</a>
                </div>
            </dd>
            ...
            <dt>
                <label>Images(Dimensions should be 600 X 450):<span style="color:red;">*</span></label>
            </dt>
            <dd>
            ...
            <dd>
                ...
                <div class="fieldbox addservedit form" style="position: relative;">
                    ...
                    <img id="mapAjaxLoader" src="/img/admin/icons/ajax_loading_nested.gif"
                         style="position: absolute; top: 5px; right: 5px; display: none;width: 20px; height: 20px;">
                </div>
                <br><br>
