...
<div>
    ...
    <div class="first-box">
        ...
        <div class="add-slots">
            ...
            <br><br>
            <button type="button" onclick="$('.check-slot').prop('checked', !$('.check-slot').prop('checked'));">Select
                all
            </button>
            <br><br>
...
<script type="text/javascript">
    ...
    foreach ($checkbox_slots[4] as $slot) {
    ?>
    weekdaySpecial += '<?php echo $slot; ?>';
    <?php
    }foreach ($checkbox_slots[5] as $slot) {
    ?>
    weekendSpecial += '<?php echo $slot; ?>';
    <?php
    }
    ?>
    ...
    if (def == 1) {
        ...
        if (weekdaySpecial != '') {
            $('#slots_content').html(weekdaySpecial);
        } else {
            $('#slots_content').html('no slots to show');
        }
    }
        ...
        if (weekendSpecial != '') {
            $('#slots_content').html(weekendSpecial);
        } else {
            $('#slots_content').html('no slots to show');
        }
    }
