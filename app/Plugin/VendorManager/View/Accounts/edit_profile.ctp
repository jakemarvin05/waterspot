        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="dashboard-file-uploader">
                    <div class="dashboard-image-uploading-status" id="change_profile"
                         style="display:none;"><?= $this->Html->image('uploading.gif'); ?> </div>
                    <?php
                    /* Resize Image */
                    ...
                    <div class="dashboard-upload-link-div">
                        <a class="dashboard-upload-image-link btn btn-primary" href="#" id="uploadFile" title="Upload">Change
                            Photo</a>
                    </div>
