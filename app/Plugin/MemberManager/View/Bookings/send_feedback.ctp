...
<?php if($review_status==0){ ?>
	<div class="right-area">
		...
		<?=$this->Form->create('ServiceReview',array('class'=>'dashboard-feedback-form','id'=>'ServiceReview','url'=>array('plugin'=>'member_manager','controller'=>'bookings',	'action'=>'send_feedback',$order_id),'novalidate' => true));?>
			...
			<div class="dashboard-form-row">
				<input class="dashboard-buttons" type="submit" value="Submit Feedback" id="submitBtn" />
                ...
                success: function(data) {
                    if(data.error==1){
                        ...
                        $.each(data.errors,function(i,v){
							...
							$('#'+i).addClass("invalid form-error").after('<span class="error-message" style="position:relative; top:-10px; font-size:13px; margin: 0; width:100%;">'+v+'</span>');
