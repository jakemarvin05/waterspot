					...
					$.ajax({
						...
						success: function(data) {
							...
							//alert(i+'--'+v.temp_name);
								...
								$('.'+settings.div_image_class).append('<div class="dashboard-service-images new col-sm-2 col-xs-4 service-image"><img src="'+v.temp_name+'" /><input type="hidden" name="'+settings.file_input_name+'" value="'+v.image+'"/><button class="close-image" data-id="'+v.image+'"><i class="fa fa-times"></i></button></div>');
								$('.img-box').remove();
								load_link();
								});
