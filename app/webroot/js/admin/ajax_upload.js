(function( $ ){
		...
		$.fn.AjaxUpload = function(options){
			...
			function load_link(){
				 var current_url= location.protocol+'//'+window.location.host;	
				 $('.'+settings.div_image_class).prepend('<div class="service-image no-image add-image"><a id="image-link-'+settings.form_counter+'" href="Javascript:void(0);"><img src="'+current_url+'/img/add-more.jpg"> </a><div class="loader" style="display:none;"></div></div>');
