...
<table width="100%">
                            ...
                            <table width="100%">
                                <tr>
                                    ...
                                    <td width="10%">
                                        ...
                                        <?php endif; ?>
                                        <?php if ($booking_detail['Booking']['status'] == 4 && $booking_detail['Booking']['vendor_confirm'] == 3): ?>
                                            <?= $this->Html->link('<img src="/img/admin/icons/icon_error.png" alt="Reject Booking" title="Reject Booking">', array('plugin' => 'vendor_manager', 'controller' => 'bookings', 'action' => 'cancel_paid', $booking_detail['Booking']['id']), array('class' => 'btn-cancel', 'escape' => false)); ?>
                                        <?php endif; ?>
                                        ...
                                        <?php if ($booking_detail['Booking']['vendor_confirm'] == 1): ?>
                                            <img src="/img/admin/icons/icon_success.png" class="read-only"
                                                 alt="Confirmed Booking" title="Confirmed Booking">
                                        <?php endif; ?>

                                        <?php if ($booking_detail['Booking']['vendor_confirm'] == 2): ?>
                                            <img src="/img/admin/icons/icon_error.png" class="read-only"
                                                 alt="Rejected Booking" title="Rejected Booking">
                                        <?php endif; ?>
    ...
    <tr>
        <td colspan="9" id="loader_pagination" style="display:none;">
            <div><?= $this->Html->image('admin/icons/ajax_loading_ladder.gif'); ?></div>
        </td>
    </tr>
    <tfoot>
    <tr>
            ...
            <?php } else { ?>
                <ul class="pagination">
                    ...
                    <?php if ($this->Paginator->hasPrev()) { ?>
                        <li><?php echo $this->Paginator->prev('< Previous', null, null, array('class' => 'disabled')); ?>
                            &nbsp;... &nbsp;</li>
                    <?php } ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        // Show confirm box when cancel button has been clicked
        $('.btn-cancel').click(
            function (e) {
                e.preventDefault();
