				...
				<tr>
					<td colspan="6">
						<table width="100%">
							...
							}else if($module['name']=='Galleries Manager'){
								$module['name']='Gallery Manager';
							}else if($module['name']=='Slides Manager'){
								$module['name']='Slide Manager';
							}else if($module['name']=='Mails Manager'){
								$module['name']='Mail Format Manager';
							}?>
