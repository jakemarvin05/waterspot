...
foreach ($search_service_lists as $search_service_list) { ?>
    ...
    <div class="activities-listing col-sm-4 col-xs-6">
        ...
        <div class="contentvisible contentselector">
            <div class="tile">
                ...
                <div class="contenthover">
                    <div class="box-center">
                        <div
                            class="short-desc"><?php echo $this->Format->Headingsubstring(strip_tags($search_service_list['Service']['description']), 250); ?></div>
                        <a href="/activity/details/<?php echo($search_service_list['slug'] ? $search_service_list['slug'] : $search_service_list['Service']['id']); ?>"
                           class="btn btnDefaults btnFillOrange">Book A Spot</a>
                    </div>
                </div>
            </div>
            ...
            <div class="tile-info">
                <h4>
                    <a href="/activity/details/<?php echo($search_service_list['slug'] ? $search_service_list['slug'] : $search_service_list['Service']['id']); ?>"><?php echo $search_service_list['Service']['service_title']; ?></a>
                </h4>
            ...
            <div class="activity-rating-wrapper" style="display:none!important;">
                <? if (!empty($search_service_list['rating'])) { ?>
                    ...
                    <?php foreach ($ratings as $rating) { ?>
                        ...
                        <input type="radio" value="<?php //echo $rating; ?>" name="test-4-rating-<?php echo $i; ?>"
                               class="star {split:2}"
                               disabled="disabled" <?php echo ($search_service_list['rating'] == $rating) ? 'checked="checked"' : ''; ?>
                        />
                    <?php }
                } ?>
                ...
                if ($ratingMark > 0):
                    ...
                    <div class="rating"
                         style="background-position: <?php echo -100 + ($ratingMark * 100); ?>px 0px"></div>
...
<script type="text/javascript">
    ...
    ( function( $, window, document, undefined )
    {
        ...
        // Look for each image and recalculate when loaded
