 ...
 */
 ...
 CakePlugin::load('SlideManager');
 CakePlugin::load('SubadminManager');
 CakePlugin::load('MailManager');
 //CakePlugin::load('VendorManager');
 CakePlugin::load('ServiceManager');
 CakePlugin::load('LocationManager');
